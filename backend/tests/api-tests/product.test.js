...
describe('/product', function () {
    ...
    describe('POST /product', function () {
        ...
        describe('POST /product Validation Error handling', function () {
            ...
            test('should throw Error 422 when no product name provided', function () {
                return request(app)
                    .post('/product/')
            ...
            test('should throw Error 422 when no description provided', function () {
                return request(app)
                    .post('/product/')
            ...
            test('should throw Error 422 when no price provided', function () {
                return request(app)
                    .post('/product/')
